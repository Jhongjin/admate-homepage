  ...
  projects: [
    {
      ...
      statusLabel: "정상",
      progress: 60,
      weeklyFocus: "정책 답변 정확도 개선과 근거 제공 화면 정리",
      deliverable: "주요 정책 질문 답변 품질 점검표",
      blockedIssue: "없음",
      nextMilestone: "답변 근거 검증 구조 설계",
      updatedAt: "2026-05-03",
    },
    {
      id: "sentinel",
    ...
    },
    {
      ...
      statusLabel: "검토 필요",
      progress: 25,
      weeklyFocus: "Meta 운영 데이터 기준과 예측 지표 범위 정의",
      deliverable: "업종/목표 분류 기준 초안",
      blockedIssue: "최근 6개월 벤치마크 기준 확정 필요",
      nextMilestone: "예측 화면과 입력 데이터 기준 정리",
      updatedAt: "2026-05-03",
    },
    {
      id: "agent_core",
